Shader "Foliage/shadowedFoliage"
{
	...
	Properties
	{
		...
		_ReduceShadows("Shadow Reduction", range(0,5)) = 0
		_ReduceShadowsThreshold("Shadow Reduction Threshold", range(0,1)) = 0.3
	...
	SubShader
	{
		...
		#pragma surface surf Standard addshadow fullforwardshadows alphatest:_Cutoff vertex:vert finalcolor:reduceShadow
